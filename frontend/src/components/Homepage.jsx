...
{/* Footer */}
<footer className="relative z-10 bg-gray-900 text-white py-4">
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div className="flex items-center justify-center gap-8">
      <div className="flex items-center gap-2">
        <div className="w-8 h-8 bg-gradient-to-br from-emerald-600 to-yellow-500 rounded-xl flex items-center justify-center shadow-lg transform rotate-12">
          <Car className="w-4 h-4 text-white -rotate-12" />
        </div>
        <span className="text-xl font-black">Ryde</span>
      </div>
      <p className="text-gray-400">&copy; 2025 Ryde. All rights reserved.</p>
    </div>
  </div>
</footer>
