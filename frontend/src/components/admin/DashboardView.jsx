    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            {loading ? (
              ...
              <>
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div>
                    <p className="text-white">New driver registration</p>
                ...
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div>
                    <p className="text-white">Ride completed</p>
                ...
                <div className="flex items-center gap-3 text-sm">
                  ...
                  <div>
                    <p className="text-white">Payment issue reported</p>
                    <p className="text-white/60">10 minutes ago</p>
                  </div>
                </div>
              </>
            )}
        ...
        <div className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-white/20">
          ...
          <div className="space-y-3">
            {[
              { service: 'Ride Service', status: 'operational', color: 'emerald' },
              { service: 'Payment Gateway', status: 'operational', color: 'emerald' },
              { service: 'Map Services', status: 'degraded', color: 'amber' },
              { service: 'Notification System', status: 'operational', color: 'emerald' },
            ].map((item, index) => (
